...
* Learned the use of comments and proper indexing.
* Committed and pushed Java files.
* **Learning:** Setting up the JDK, JRE, and understanding the JVM architecture (Write Once, Run Anywhere).
* **Tools:** Installed IntelliJ/Eclipse and configured environment variables.
...
* Committed and pushed solutions to the repository.
* Code: [Core-Java Scenario_Based](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/core-java-practice/scenario-based-codebase)
...
* Committed and pushed solutions to the repository.
* View Code : [Core-Java Scenario_Based](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/core-java-practice/scenario-based-codebase)
...
* Committed and pushed solutions to the repository.
* View Code : [Core-Java Scenario-Based](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/core-java-practice/scenario-based-codebase)
...
* Committed and pushed solutions to the repository.
* View Code : [OOPs Scenario-based](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java-oops-practice/java-oops-practice/scenario-based-codebase/oops_scenario_based/src)
* View Code : [Core-Java eetCode](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/core-java-practice/leet-code-codebase)
...
**Date:** 07-Jan-2026
* Started the day with a weekly review session by Mentor.
...
* Solved 2 Scenario-Based Problems.
* Solved some real world problems by implementing OOPs concepts.
* Studied java DSA concepts and their real world implementations.
* Committed and pushed solutions to the repository.
* View Code : [OOPs Scenario-based](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java-oops-practice/java-oops-practice/scenario-based-codebase/oops_scenario_based/src)
* View Code : [DSA]()
---
...
* Solved 3 leetcode questions of core-java Concepts.
* Committed and pushed solutions to the repository.
* View Code : [OOPs Scenario-based](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java-oops-practice/java-oops-practice/scenario-based-codebase/oops_scenario_based/src)
* View Code : [Core-Java leetcode](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/core-java-practice/leet-code-codebase)
---
...
* Learnt how lambda expressions help in making code efficient and shorter.
* Implemented different functional interfaces.
* Learnt how functional interfaces like Predicate, function, Supplier and consumer are used in Lambda expressions.
* Learnt about Method references.
* studied how method reference help define shorthand for lambda expressions.
* Explored different features of Java 8.
* Practiced problems.
* View Code :  [Lambda Expressions](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java8-programming-practice/gcr-codebase/java8_practice/src/com/lambda_expressions)
* View Code :  [Functional Interface ](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java8-programming-practice/gcr-codebase/java8_practice/src/com/functional_interface)
* View Code :  [Method Reference](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java8-programming-practice/gcr-codebase/java8_practice/src/com/method_references)
---
### Day 2 - Stream API.
**Date:** 28-Jan-2026
...
---
### Day 4 - Workshop of java 8
**Date:** 30-Jan-2026
* Developed a Smart City system using java 8 features.
* used java 8 features to make the system efficient and interactive.
* Learnt how different java 8 features help minimizing labour and workload if used properly.
* Pushed solution to the github. 
* View Code : [ Java 8 Workshop](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java8-programming-practice/gcr-codebase/java8_practice/src/com/workshop/smartCity)
---
### Day 5 - Scenario Based questions practice of Java 8
**Date:** 31-Jan-2026
* Studied about implementing Java 8 features.
* Practiced scenario-based problems with help of java 8 features.
* Explored problems of :
 >1. Lambda expressions.
 >2. Stream API & Collectors.
 >3. Functional Interfaces
* Solved questions over stream API.
* View Code : [ Java 8 Scenario-based](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java8-programming-practice/scenario-based-codebase/java8_scenario_based/src/com) 
---
---
## Week 8 :  Design Patterns and Principles  & Multithreading in java & JDBC
---
---
...
* View Code : [ Design patterns & principles ](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java-design-pattern-practice/gcr-codebase/design_pattern_practice/src/com/design_patterns/libraryManagementSystem) 
---
...
* Learnt about many patterns such as :
 ...
 >2. Structural Patterns – deal with object composition (e.g., Adapter, Composite, Decorator).
 >3. Behavioral Patterns – deal with communication/interaction (e.g., Observer, Strategy, Command).
* Practiced and pushed solutions on GitHub.
* View Code : [Design patterns and principles](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java-design-pattern-practice/gcr-codebase/design_pattern_practice/src/com/design_patterns/libraryManagementSystem) 
---
...
* Practiced and pushed solutions on GitHub.
* View Code : [Multithreading practice](https://github.com/Harsh-Raj-Singh25/BridgeLabz-Training/tree/java-design-pattern-practice/gcr-codebase/design_pattern_practice/src/com/multithreading/practice) 
---
