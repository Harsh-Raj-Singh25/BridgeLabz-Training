...
public class Vehicle {
	   ...
	   public static void main(String[] args) {
	       ...
	       Vehicle.updateRegistrationFee(15000.0); // Set registration fee to $150.0
	       // Create new vehicle instances
	       Vehicle vehicle1 = new Vehicle("Harsh raj", "Scorpio", "BR312502");
	       Vehicle vehicle2 = new Vehicle("Price kumar", "SUV", "XYZ789");
